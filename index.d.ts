 ...
 */
declare function getStats<Name extends string | undefined>(statsName?: Name): undefined extends Name ? GlobalStats | undefined : ProfileStats | undefined;
/**
 ...
 */
type CacheEvent<Type extends CacheEventType, Fn extends (...args: any[]) => any> = Type extends 'add' ? OnAddEvent<Fn> : Type extends 'delete' ? OnDeleteEvent<Fn> : Type extends 'hit' ? OnHitEvent<Fn> : Type extends 'update' ? OnUpdateEvent<Fn> : never;
/**
 * A listener for the given type of cache event.
 */
type CacheEventListener<Type extends CacheEventType, Fn extends (...args: any[]) => any> = (event: CacheEvent<Type, Fn>) => void;
/**
 ...
 */
type ShouldRemoveOnExpire<Fn extends (...args: any[]) => any> = (key: Key, value: ReturnType<Fn>, time: number, cache: Cache<Fn>) => boolean;
/**
 ...
 */
type Options<Fn extends (...args: any[]) => any> = OptionsNoCustomEqual<Fn> | OptionsKeyEqual<Fn> | OptionsKeyItemEqual<Fn>;
/**
...
interface Memoize {
    ...
    <Fn extends Memoized<(...args: any[]) => any, Options<(...args: any[]) => any>>, Opts extends Options<Fn['fn']>>(fn: Fn, passedOptions: Opts): Memoized<Fn['fn'], Fn['options'] & Opts>;
